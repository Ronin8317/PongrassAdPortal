...
import adportal.pongrass.com.au.pongrassadportal.data.Location;
...
public class LocationListActivity extends AppCompatActivity {
    ...
    private void setupRecyclerView(@NonNull RecyclerView recyclerView) {
        recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter(Location.ITEMS));
    }

    public class SimpleItemRecyclerViewAdapter
            extends RecyclerView.Adapter<SimpleItemRecyclerViewAdapter.ViewHolder> {

        private final List<Location.LocationEntry> mValues;

        public SimpleItemRecyclerViewAdapter(List<Location.LocationEntry> items) {
            mValues = items;
        }
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public Location.LocationEntry mItem;
